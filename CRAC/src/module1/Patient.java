...
public class Patient extends Identite{
	...
	public Patient(String p, String n, String s, Date d) {
		super(p,n,s,d);

	}
	
	
	public Patient(String p, String n, String s, Date d, ArrayList<IdentiteAdministrative> ia, ArrayList<Cancer> ca) {
		super(p,n,s,d);
	...
	public Patient(String p, String n, String s, Date d, ArrayList<IdentiteAdministrative> ca) {
		super(p,n,s,d);
